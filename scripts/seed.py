...
ROWS = [
    dict(
        ...
        category="Login & SSO", assignee="J. Nasir",
        requester="Dana Whitfield", email="dana@northgate.io", org="Northgate",
        ...
        first_response=5.0,
        events=[
            (5.0, "J. Nasir", "comment", "Picking this up now. Can you confirm whether the "
            ...
            (4.0, "J. Nasir", "note", "Stale cert in the SP metadata. Same root cause as TKT-0987."),
        ],
    ),
    dict(
        ref="TKT-1042", hours=52, priority="P2", status="Open", track="it",
        category="Security concern", assignee="R. Okafor",
        requester="Marcus Bell", email="mbell@internal.corp", org="Internal",
    ...
    dict(
        ...
        requester="Owen Baptiste", email="obaptiste@lyra-health.com", org="Lyra Health",
    ...
    dict(
        ...
        requester="Priya Raghavan", email="priya@ferrous.dev", org="Ferrous",
    ...
    dict(
        ...
        requester="Colin Yates", email="cyates@internal.corp", org="Internal",
    ...
    dict(
        ...
        requester="Amara Sowande", email="asowande@internal.corp", org="Internal",
